        ...
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-6 text-center">
                <div class="imagen1 mb-3">
                    <img src="images/imagen1.png" class="img-fluid" alt="Imagen institucional">
                </div>
                <div class="imagen2 mb-3">
                    <img src="images/logo1.png" class="img-fluid" alt="Logo institución">
                </div>
                
                <h1 class="mb-2">IE N° 2079 "ANTONIO RAIMONDI" 2024</h1>
                ...
                <div class="mt-4">
                    <a href="../login/login.php" class="btn btn-outline-primary">Acceso Administrativo</a>
                </div>
            </div>
        </div>
    </div>
